...
class PaymentHandler:
    ...
    async def handle_send_proof_callback(self, call):
        ...
        if d.startswith("crypto_sent_"):
            ...
            await self.bot.send_message(
                ...
                "📸 <b>أرسل لقطة شاشة والرقم الذي قمت بالتحويل منه:</b>"
            )
    ...
    async def _show_payment_details(self, cid, mid, method):
        details = {
            "vodafone": (
                "📱 <b>فودافون كاش</b>\n\n"
                "📲 <b>رقم التحويل:</b> <code>01002495127</code>\n\n"
                "<b>للشحن اتبع الخطوات التالية:</b>\n"
                "1️⃣ انسخ الرقم أعلاه.\n"
                "2️⃣ قم بتحويل المبلغ الذي تريده عبر تطبيق فودافون كاش.\n"
                "3️⃣ بعد التحويل، اضغط على <b>إرسال الإيصال</b> وأرسل لقطة شاشة مع الرقم الذي قمت بالتحويل منه."
            ),
            "crypto": (
                "🔐 <b>كريبتو (يدوي)</b>\n\n"
